...
import { deleteAccount, seekerUpdateAccount } from "../../../requests/accountUpdate";
                        ...
                        <div className="Filters__form">
                            ...
                            <div className="Filters__filterItem">
                                ...
                                <input type="text" id="last_name" name="last_name"
                                    className="TextField__PurpleOutline signup-fields" placeholder="Last Name" value={formData.last_name} onChange={handleChange} required />
                            </div>
                            <div className="Filters__filterItem">
                                <label htmlFor="dob" className="signup-labels">Date of Birth:</label>
                                <input type="date" id="dob" name="dob" className="TextField__PurpleOutline special-fields" value={formData.dob}  onChange={handleChange} />
                            </div>
                            <div className="Filters__filterItem">
