...
class UpdateUserSerializer(ModelSerializer):
    ...
    class Meta:
        model = PetHubUser
        fields = ('id', 'email', 'role', 'first_name', 'last_name', 'gender', 'dob', 'postal_code', 'image', 'shelter_name', 'street_address', 'city', 'province', 'open_time', 'close_time', 'role', 'phone_number', 'description', "animals_offered")
