...
from petlistings.models import ANIMAL_BIRD, ANIMAL_CAT, ANIMAL_DOG, ANIMAL_FISH, BREED_CORGI, BREED_GERMAN_SHEPHERD, BREED_LABRADOR, BREED_PUSSYCAT, BREED_RETRIEVER
...
class StrayAnimal(models.Model):
    ...
    animal = models.CharField(max_length=20, choices=((ANIMAL_DOG, 'Dog'), (ANIMAL_CAT, 'Cat'), (ANIMAL_BIRD, 'Bird'),
                                                      (ANIMAL_FISH, 'Fish'), (ANIMAL_UNKNOWN, 'Unknown')), null=False)
